...
#if __ATCODER__ == 1
void solve(long long N, long long M, std::vector<long long> a, std::vector<long long> b, std::vector<long long> c, long long Q, std::vector<long long> d, std::vector<long long> e, std::vector<long long> f) {
}
...
void solve() {
    ...
    solve(N, M, std::move(a), std::move(b), std::move(c), Q, std::move(d), std::move(e), std::move(f));
}
#else
void solve() {
}
